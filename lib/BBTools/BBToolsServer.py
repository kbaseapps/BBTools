...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'BBTools'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from BBTools.BBToolsImpl import BBTools  # noqa @IgnorePep8
impl_BBTools = BBTools(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'BBTools'
        ...
        self.rpc_service.add(impl_BBTools.run_mem_estimator,
                             name='BBTools.run_mem_estimator',
                             types=[dict])
        self.method_authentication['BBTools.run_mem_estimator'] = 'none'  # noqa
        self.rpc_service.add(impl_BBTools.bbtools_version,
                             name='BBTools.bbtools_version',
                             types=[])
        self.method_authentication['BBTools.bbtools_version'] = 'none'  # noqa
